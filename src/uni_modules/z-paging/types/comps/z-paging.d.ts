...
declare interface ZPagingProps {
   ...
   */
  onScroll?: (
    event: ZPagingParams.ScrollInfo | ZPagingParams.ScrollInfoN,
  ) => void;
...
declare interface _ZPagingRef<T = any> {
  ...
  complete: (
    data?: T[] | false,
    success?: boolean,
  ) => Promise<ZPagingParams.ReturnData<T>>;
...
declare interface _ZPaging {
  new (): {
    $props: AllowedComponentProps & VNodeProps & ZPagingProps;
    $slots: ZPagingSlots;
  };
}
